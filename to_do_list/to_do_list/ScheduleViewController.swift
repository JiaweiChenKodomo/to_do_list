...
//  to_do_list
//
//  Use EventKit to manage all scheduled events.
//
//  Created by Jiawei Chen on 1/10/23.
//
//  Most of the functions created by Richard Topchii on 09.05.2021.
//
...
class ScheduleViewController: DayViewController, EKEventEditViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Manually setting the appearance of navigation bar.
...
//        }
    ...
    @objc func didTapAdd() {
        ...
        guard let vc = storyboard?.instantiateViewController(withIdentifier: "addevent") as? AddScheduleEventViewController else {
            return
        }
        vc.completionHandler = { [weak self] in
            self?.reloadData()
        }
        vc.title = "New Schedule Item"
