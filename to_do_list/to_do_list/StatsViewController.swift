...
//        scrollView.addSubview(textFieldUp)
        ...
        fromLabel.frame = CGRect(x: 30, y: yStart + 20, width: 320, height: 50)
        scrollView.addSubview(fromLabel)
        
        startDatePicker.setDate(Date().addingTimeInterval(-1209600), animated: true)
        startDatePicker.frame = CGRect(x: 165, y: yStart + 20, width: 320, height: 50)
        ...
        toLabel.frame = CGRect(x: 30, y: yStart + yOffset, width: 320, height: 50)
        scrollView.addSubview(toLabel)
        
        endDatePicker.setDate(Date(), animated: true)
        endDatePicker.frame = CGRect(x: 165, y: yStart + yOffset, width: 320, height: 50)
...
//            print(diffTime.day)
        ...
        set5.setColor(UIColor(red: 0.831, green: 0.165, blue: 0.204, alpha: 0.2))
        //set5.lineDashLengths = [20]
        set5.drawCirclesEnabled = false
        set5.lineWidth = 3.0
        
        let set6 = LineChartDataSet(entries: aveVal4, label: "Average Finished")
        set6.setColor(UIColor(red: 0.384, green: 0.792, blue: 0.314, alpha: 0.2))
